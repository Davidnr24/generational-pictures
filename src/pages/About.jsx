    ...
    const members = [
        {
            ...
            ps: [
                ...
                dedication to reshaping narratives and fostering inclusivity and positivity in a world that needs it.'
            ],
            pic: felicita_image,
    ...
    return (
        <div className='px-10 md:px-20 lg:px-32 pt-[80px] xl:px-48 pb-32 w-screen max-w-screen h-fit bg-black flex flex-col justify-start items-start min-h-[100vh] '>
            <div className='flex flex-col mt-[50px] justify-start items-start gap-3 lg:w-1/2'>
                ...
                <p className='font-zenKaku text-white h-fit w-full [text-align:center] md:[text-align:left]'> Generational Pictures is a recently founded woman-owned video production company backed by the expertise of co-founders Felícita Kostianis and Emmy Award Winning Director of Photography, 
                Chris Kostianis. As a new company founded by the father-daughter duo, we are bringing their above-and-beyond mindset to the level of a full-service production and post-production company. By constantly questioning, 
                “What’s impossible that we can achieve through our work?” Generational Pictures is a company dedicated to making our clients’ visions into extraordinary visual realities.
                </p>
            </div>
