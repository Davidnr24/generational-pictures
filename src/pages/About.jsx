    ...
    return (
        <div className='px-10 md:px-20 lg:px-32 pt-[80px] xl:px-48 pb-32 w-screen max-w-screen h-fit bg-black flex flex-col justify-start items-start min-h-[100vh] '>
            <div className='flex flex-col mt-[50px] justify-start items-start gap-3 lg:w-1/2'>
                ...
                <p className='font-zenKaku text-white h-fit w-full [text-align:center] md:[text-align:left]'> Generational Pictures is a woman-owned video production company backed by the expertise of co-founders Felícita Kostianis and Emmy Award Winning Director of Photography, 
