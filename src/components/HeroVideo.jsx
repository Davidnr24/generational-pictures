			...
			>
				...
				<div className="absolute flex justify-start items-center w-full h-full grow top-0 left-0 bg-gradient-to-r from-black to-black/40">
					<div className='flex flex-col justify-center items-start gap-0 lg:gap-20 ml-10 md:ml-20 xl:ml-48'>
						...
						<Link to='/about' className='no-underline lg:text-xl bg-[transparent] text-white w-auto h-auto p-3 font-zenKaku border-[1px] font-bold border-logo lg:border-logo-white lg:hover:border-logo  lg:hover:bg-black transition-all duration-300'>
							Learn More
						</Link>
					</div>
				</div>
