...
const classNameLinks = "no-underline text-logo hover:text-logo-second w-fit"

const classNameIcons = "no-underline text-logo hover:opacity-75"
      ...
      <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className='flex flex-col justify-center items-center'>
            ...
            <div class="flex mt-2 space-x-6 text-logo">
