...
const classNameLinks = "no-underline text-logo-white hover:text-gray-400 w-fit"
          ...
          <div className='flex flex-col justify-start items-start'>
            ...
            <div class="flex mt-2 space-x-6">
              <Link className={classNameIcons} to target="_blank" rel="noreferrer">
                ...
                <svg class="w-6 h-6" fill={icons_color} viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p class={`mt-8 text-xs ${textColor}`}>
