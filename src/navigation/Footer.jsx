...
const classNameLinks = "no-underline text-logo-white hover:text-logo-second w-fit"

const classNameIcons = "no-underline text-logo-white hover:opacity-75"
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className='flex flex-col justify-center items-center'>
            ...
            <div class="flex mt-2 space-x-6">
              <Link className={classNameIcons} to target="_blank" rel="noreferrer">
                <span class="sr-only"> Facebook </span>
                <svg class="w-6 h-6" fill="logo" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <p class={`mt-8 text-xs ${textColor} self-center`}>
          ...
          <div class="grid grid-cols-2 gap-8 lg:col-span-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <nav class="flex flex-col mt-4 space-y-2 text-sm">
                <Link className={classNameLinks} to> Privacy Policy </Link>
